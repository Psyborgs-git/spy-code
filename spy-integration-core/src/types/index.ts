...
// Error types
export class SpyCodeError extends Error {
  constructor(
    message: string,
    public code: string,
    public details?: any
...
export class CLIError extends SpyCodeError {
...
export class MCPError extends SpyCodeError {
  constructor(message: string, details?: any) {
...
export class CacheError extends SpyCodeError {
  constructor(message: string, details?: any) {
