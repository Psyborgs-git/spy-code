"use strict";
/**
 * Cursor Extension Main Entry Point
 * Reuses VS Code extension code since Cursor is VS Code-based
 */
...
async function activate(context) {
    console.log('Spy-Code Cursor extension is activating');
    // Get configuration
    ...
    console.log('Spy-Code Cursor extension activated successfully');
}
async function deactivate() {
    console.log('Spy-Code Cursor extension is deactivating');
    if (adapter) {
    ...
    console.log('Spy-Code Cursor extension deactivated');
}
