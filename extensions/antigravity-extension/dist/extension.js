 ...
 */
function registerAntigravityHooks(context) {
    ...
    agentHooks.registerHook(integration_core_1.HookType.PRE_RUN_COMMAND, async (hookContext) => {
        try {
    ...
    agentHooks.registerHook(integration_core_1.HookType.POST_RUN_COMMAND, async (hookContext) => {
        try {
    ...
    agentHooks.registerHook(integration_core_1.HookType.POST_SETUP_WORKTREE, async (hookContext) => {
        try {
